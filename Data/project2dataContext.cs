...
{
    public partial class project2dataContext : DbContext
    {
        public project2dataContext()
        {
        }

        public project2dataContext(DbContextOptions<project2dataContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<Project2Db> Project2Db { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Initial Catalog=project2data; Data Source=LAPTOP-8LJCR98V\\SQLEXPRESS; Trusted_Connection=true");
            }
#pragma warning disable
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Project2Db>(entity =>
            {
                entity.HasKey(x=>x.EmployeeNumber);

                entity.ToTable("project2_DB");
        ...
        public DbSet<Dimension.Models.EmployeeModel> EmployeeModel { get; set; }
    }
}
